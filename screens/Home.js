              ...
              <View style={styles.carddetail}>
                <View>
                  ...
                  <View style={{ flexDirection: 'row' }}>
                    <Entypo name="user" size={24} style={{ paddingTop: 10, paddingRight: 10 }} color='black' />
                  ...
                  <View style={{ flexDirection: 'row' }}>
                    <Entypo name="location" size={24} style={{ paddingTop: 10, paddingRight: 10 }} color='black' />
                    <Text style={styles.title}>Pune</Text>
                  </View>
                ...
                <View style={styles.carPhoto}>
                  <Image
                    source={{ uri: "https://cdn3d.iconscout.com/3d/premium/thumb/car-4741990-3945475.png" }}
                    style={styles.backgroundImage}
                  />
                </View>
              </View>
              <Text style={styles.footerText}>No. MH14 AK 2626</Text>
            </View>
            {/* // */}
            <View style={styles.card}>
              <View style={styles.carddetail}>
            ...
            <View style={styles.card}>
              <View style={styles.carddetail}>
                <View>
                  <View style={{ flexDirection: 'row' }}>
                    <Entypo name="user" size={24} style={{ paddingTop: 10, paddingRight: 10 }} color='black' />
                    <Text style={styles.title}>Pravin</Text>
                  </View>
                  <Text style={styles.title}>BMW</Text>
                  <View style={{ flexDirection: 'row' }}>
                    <Entypo name="location" size={24} style={{ paddingTop: 10, paddingRight: 10 }} color='black' />
